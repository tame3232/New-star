...
const fetch = require('node-fetch'); // <-- አዲስ: የቴሌግራም APIን ለመጥራት

// ----------------------------------------------------
// TELEGRAM ውቅር (CONFIGURATION)
// ----------------------------------------------------
// የእርስዎ የቦት Token - እዚህ ላይ በቀጥታ እናስገባለን
const TELEGRAM_TOKEN = '7317476895:AAEoGmOv0Hq18ykZTx4EsafOUaND2XuCPKU';
    ...
    try {
        ...
        if (data.message) {
            ...
            if (messageText && messageText.startsWith('/start')) {
                const welcomeMessage = `ሰላም ${firstName}፣ እንኳን ደህና መጡ። ነጥብ ለማግኘት Web App ለመክፈት ከታች ያለውን አገናኝ ይጠቀሙ።`;
